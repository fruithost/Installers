...
install_mysql() {
	...
	echo "deb [signed-by=/etc/apt/keyrings/mariadb-keyring.pgp] https://mirror.23m.com/mariadb/repo/11.2/debian bookworm main" >> /etc/apt/sources.list
...
update_config() {
	...
	# PHP
 	ln -s /etc/fruithost/config/php/php.ini /etc/php/8.2/fpm/php.ini 	
